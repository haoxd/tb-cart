...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link href="${ctx}/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
   <title>我的购物车 - 嗨淘商城</title>
   <script>
   	var pageConfig  = {};
   </script>
<body> 
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.tb.com/"><img clstag="clickcart|keycount|xincart|logo" src="${ctx}/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            <div class="cell p-checkbox" id="p-checkbox"><input data-bind="cbid:1" class="checkbox" type="checkbox" name="checkItem" id="checkItem${cart.itemId }" checked="" value="${cart.itemId }"></div>
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="http://www.tb.com/item/${cart.itemId }.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.itemImage}" alt="${cart.itemTitle}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="http://www.tb.com/item/${cart.itemId }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.itemTitle}</a>
		            ...
		            <div class="cell p-remove"><a id="${cart.itemId}" data-more="removed-87.20-1" clstag="clickcart|keycount|xincart|btndel318558" class="cart-remove" href="javascript:void(0);">删除</a>
		            </div>
		        </div>
	        </div> 
        </c:forEach>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="http://www.tb.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
          </div>
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://www.tb.com/order/cart/createorder.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
...
<script type="text/javascript" src="${ctx}/js/jquery.price_format.2.0.min.js"></script>
